...
import { headSketch, loadingSketch, tipSketch, pixelSketch, mottoSketch, gradientSketch, twoSquareSketch } from '../utils/sketches/basicSketches';
      ...
      if(type == "basic"){
        switch (style) {
          ...
          case 'motto':
            ...
            break;
          case 'gradient':
            sketch = (p) => gradientSketch(p, canvasRef, onP5Update, color, values);
            break;
          case 'overlap':
            sketch = (p) => twoSquareSketch(p, canvasRef, onP5Update, color, values);
            break;
          case 'head':
          default:
