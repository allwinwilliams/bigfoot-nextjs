...
const AutoScrollCards = () => {
  const items = [
    ...
    { imgUrl: '/song-tshirt/option/1.png', title: 'Lose Yourself', description: 'Eminem', link: '/product?color=black&size=M&songId=7MJQ9Nfxzh8LPZ9e9u68Fq&style=minimal' },
    ...
    { imgUrl: '/song-tshirt/option/1.png', title: 'Baby One More Time', description: 'Britney Spears', link: '/product?color=black&size=M&songId=3MjUtNVVq3C8Fn0MP3zhXa&style=minimal' },
    ...
    { imgUrl: '/song-tshirt/option/1.png', title: 'Dynamite', description: 'BTS', link: '/product?color=black&size=M&songId=5QDLhrAOJJdNAmCTJ8xMyW&style=standout' },
    { imgUrl: '/song-tshirt/option/1.png', title: 'In the End', description: 'Linkin park', link: '/product?color=beige&size=M&songId=60a0Rd6pjrkxjPbaKzXjfq&style=standout' },
    ...
    { imgUrl: '/song-tshirt/option/1.png', title: 'Viva La Vida', description: 'Coldplay', link: '/product?color=beige&size=M&songId=1mea3bSkSGXuIRvnydlB5b&style=standout' },
