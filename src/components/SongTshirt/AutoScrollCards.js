...
const AutoScrollCards = () => {
  const items = [
    ...
    { imgUrl: '/song-tshirt/option/1.png', title: 'Billie Jean', description: 'Micheal Jackson', link: '/product/songtshirt?color=beige&size=M&songId=5ChkMS8OtdzJeqyybCc9R5&style=analysis' },
