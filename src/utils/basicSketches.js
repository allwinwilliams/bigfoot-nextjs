...
export const headSketch = (p, canvasRef, onP5Update, color, values) => {
    ...
    const shapes = [
        { x: 32.4297, y: 81.5469, width: 16.6903, height: 16.6903, fill: '#EF0000' },
        { x: 49.1172, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 65.3203, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 81.5469, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 97.7656, y: 81.5469, width: 16.6903, height: 16.6903, fill: '#EF0000' },
        { x: 114.438, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 130.664, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 146.875, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 163.094, y: 81.5469, width: 16.6903, height: 16.6903, fill: '#EF0000' },
        { x: 179.781, y: 81.5469, width: 16.2134, height: 16.6903, fill: '#EF0000' },
        { x: 65.3203, y: 98.2344, width: 16.2134, height: 16.2134, fill: '#EF0000' },
        { x: 81.5469, y: 98.2344, width: 16.2134, height: 16.2134, fill: '#EF0000' },
        { x: 97.7656, y: 98.2344, width: 16.6903, height: 16.2134, fill: '#EF0000' },
        { x: 130.664, y: 98.2344, width: 16.2134, height: 16.2134, fill: '#EF0000' },
        { x: 146.875, y: 98.2344, width: 16.2134, height: 16.2134, fill: '#EF0000' },
        { x: 163.094, y: 98.2344, width: 16.6903, height: 16.2134, fill: '#EF0000' },
        { x: 81.5469, y: 114.438, width: 16.2134, height: 16.2134, fill: '#EF0000' },
        { x: 97.7656, y: 114.438, width: 16.6903, height: 16.2134, fill: '#EF0000' },
        { x: 146.875, y: 114.438, width: 16.2134, height: 16.2134, fill: '#EF0000' },
        { x: 163.094, y: 114.438, width: 16.6903, height: 16.2134, fill: '#EF0000' },
